...
// ============================================================
// AddProductModal — adapta ao contexto (loja vs evento) e permite
// escolher de receitas existentes ou criar produto custom rápido.
// ============================================================
type RecipeLite = { id: string; name: string; public_price: number | null; promo_price: number | null; image_url: string | null };
